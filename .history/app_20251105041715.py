...
# Werkzeug default access log-ийг товчилж намсгах
...
def _log_request(resp):
    try:
        ...
        # /api/path хариу JSON бол зарим үзүүлэлтийг онцолж харуулъя
        meta = {}
        ...
        # Логдоо өөр дээрээ унахгүй байхын тулд
        pass
    return resp
